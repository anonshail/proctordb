  ...
  <html>
    ...
    <nav>
        <div class="nav-wrapper container" style="margin-top: 2%">
          ...
          <a href="#" class="brand-logo left"><img src="images/logo.png" class="logo" alt="logo"></a>
    ...
    <script type="text/javascript" src="js/init.js"></script>
      ...
      <div class="card-panel">
        <h1 class="center-align">Basic Information</h1>
        ...
        <form>
          ...
          <div class="row">
            <div class="col s6 input-field">  <!--LG's Name-->
              ...
              <label class="active black-text" for="lgname">Gaurdian's Name</label>
            </div>

            <div class="col s6 input-field">  <!--LG's Email ID-->
              <input id="lgemail" type="Email" class="validate">
              <label class="active black-text" for="lgemail">Gaurdian's Email</label>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col s6 input-field">  <!--LG's occupation-->
              ...
              <label class="active black-text" for="lgoccupation">Occupation</label>
            </div>

            <div class="col s6 input-field">  <!--LG's conatct-->
              <input id="lgtel" type="tel" class="validate">
              <label class="active black-text" for="lgtel">Gaurdian's Contact Number</label>
            </div>
          </div>
